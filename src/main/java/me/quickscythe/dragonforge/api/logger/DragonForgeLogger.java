package me.quickscythe.dragonforge.api.logger;
 ...
 * Represents a logger
 */
public class DragonForgeLogger {

    DragonForgeIntegration integration;
     ...
     */
    public DragonForgeLogger(DragonForgeIntegration integration) {
